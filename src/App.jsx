          ...
          {page === 'apply' && (
            <>
              ...
              <p className="text-gray-300 mb-6">
                Interested in joining LSPD? Review the requirements below and submit your application when recruitment opens.
              </p>

              <div className="bg-[#0f172a] border border-blue-900 rounded-xl p-5">
                <h3 className="text-2xl font-bold mb-4">Applicant Requirements</h3>
                <ul className="space-y-3 text-gray-300">
                  <li>• Must be professional and respectful in roleplay.</li>
                  <li>• Must understand server rules and chain of command.</li>
                  <li>• Must be willing to complete training.</li>
                  <li>• Must remain active within the department.</li>
                </ul>
              </div>
            </>
          )}
