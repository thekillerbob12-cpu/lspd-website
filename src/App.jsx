          ...
          {page === 'about' && (
            <>
              ...
              <div className="grid md:grid-cols-3 gap-5">
                <ImageCard image="/patrol.jpg" title="Patrol Operations" text="Active patrol units maintain public safety." />
                <ImageCard image="/command.jpg" title="Command Leadership" text="Command staff oversees department standards." />
                <ImageCard image="/community.jpg" title="Community Engagement" text="LSPD works to build trust through professionalism." />
              </div>
            </>
          )}
            ...
            <>
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                ...
                <a href="https://discord.gg/RaERpXvuVH" target="_blank" rel="noreferrer" className="bg-[#0f172a] border border-blue-900 rounded-2xl p-6 hover:bg-blue-950 transition">
                  <h3 className="text-2xl font-bold mb-2">Royalty County Roleplay</h3>
